      ...
      >
        ...
        >
          <i
            :class="{
              'heading-icon': true,
              'simple-icon-check': data.status === 'Completada',
              'simple-icon-refresh': data.status !== 'Completada',
            }"
          />
          <span class="align-middle d-inline-block">Prueba de Nota</span>
        </a>
        ...
        <div class="w-15 w-xs-100">
          <b-badge :variant="data.labelColor" pill>Notas Personales</b-badge>
        </div>
      </b-card-body>
      <div
