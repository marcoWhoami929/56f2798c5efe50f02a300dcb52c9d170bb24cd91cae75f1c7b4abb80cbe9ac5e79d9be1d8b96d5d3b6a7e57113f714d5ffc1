  ...
  <b-row>
    <b-colxx xxs="12">
      ...
      >
          ...
          <b-row>
            <b-colxx xxs="12" lg="4" class="mb-4 col-left">
              <b-card no-body class="mb-4">
                ...
                <single-lightbox
                  thumb="/assets/img/profiles/user.jpg"
                  large="/assets/img/profiles/user.jpg"
            ...
            <b-colxx xxs="12" lg="8" class="mb-4 col-right">
              <b-row>
                <b-colxx
                  v-for="(product, productIndex) in produtcs"
                  xxs="12"
                  lg="6"
                  xl="4"
                  class="mb-4"
        ...
        <b-tab :title="$t('pages.students')">
          <b-row>
            <b-colxx
              v-for="(follower, followerIndex) in followers"
              xxs="12"
              md="6"
              lg="4"
