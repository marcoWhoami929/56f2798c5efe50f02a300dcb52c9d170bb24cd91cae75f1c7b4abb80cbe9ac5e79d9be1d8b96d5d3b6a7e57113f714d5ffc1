  ...
  <application-menu>
    ...
    >
      <div class="p-4">
        ...
        <ul class="list-unstyled mb-4">
          <li class="nav-item">
            <a href="#">
              ...
              <span class="d-inline-block">{{ $t("survey.all-lessons") }}</span>
          ...
          <li class="nav-item">
            <a href="#">
              ...
              <span class="d-inline-block">{{
                $t("survey.active-lessons")
              }}</span>
              <span class="float-right">{{
                items ? items.filter((x) => x.status === "PENDING").length : 0
              }}</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="#">
              ...
              <span class="d-inline-block">{{
                $t("survey.completed-lessons")
              }}</span>
              <span class="float-right">{{
                items ? items.filter((x) => x.status === "COMPLETED").length : 0
              }}</span>
            </a>
          </li>
        </ul>
        ...
        <div>
          <p
            class="d-sm-inline-block mb-1"
            v-for="(l, index) in labels"
            :key="index"
          >
            <a href="#">
              <b-badge pill :variant="`outline-${l.color}`" class="mb-1 mr-1">{{
                l.label
              }}</b-badge>
            </a>
          </p>
